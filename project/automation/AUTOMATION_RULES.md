...
- No fluxo centrado em Projeto, o **Project Engine** é a primeira Engine de contexto de projeto, **acionada pelo MOBS Core**; os demais módulos habilitados seguem o fluxo autorizado — não como sequência universalmente posterior à resolução de Projeto.
